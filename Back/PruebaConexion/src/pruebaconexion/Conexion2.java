...
DefaultTableModel modelo;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String temp1=String.valueOf(campo1.getText());
        String temp2=String.valueOf(campo2.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conexion2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
